...
def main(spark, train_path, val_path, test_path):
    ...
    for numrow in [0.3]:#[0.001, 0.005, 0.01, 0.05, 0.1, 0.15, 0.2, 0.3]:#[49923, 248838, 497832, 2492065, 4982921, 7471981, 9963586, 17435567]: # of rows - 0.1%, 0.5%, 1%, 5%, 10%, 15%, 20%, 30% of all records - from light
